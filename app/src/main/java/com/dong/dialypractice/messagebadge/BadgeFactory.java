...
public class BadgeFactory {
	...
	public static BadgeView createOval(Context context) {
		return new BadgeView(context).setBadgeLayoutParams(23, 17)
				.setTextSize(12)
				.setBadgeGravity(Gravity.RIGHT | Gravity.TOP)
				.setBackgroundShape(BadgeView.SHAPE_OVAL);
	}

	public static BadgeView createOval2(Context context) {
		return new BadgeView(context).setBadgeLayoutParams(25, 17)
				.setTextSize(12)
				.setBadgeGravity(Gravity.RIGHT | Gravity.TOP)
				.setBackgroundShape(BadgeView.SHAPE_OVAL);
	}
