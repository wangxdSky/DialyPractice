 ...
 */
public class GrayLoadingRefreshHeader implements RefreshHeader {
    ...
    public GrayLoadingRefreshHeader(Context context, OnPercentListener onPercentListener) {
    ...
    public View getView(ViewGroup container) {
        View view = LayoutInflater.from(context).inflate(R.layout.common_gray_loading_refresh_header, container, false);
