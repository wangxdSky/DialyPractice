...
public class GestureImageView extends ImageView
    ...
    private int lastX;
    private int lastY;
    private OnScroolInstanceListener mOnScroolInstanceListener;
    ...
    public boolean onTouchEvent(@NonNull MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                lastX = x;
                lastY = y;
                Log.e("GestureImageView", "ACTION_DOWN offsetY:");
                break;
            case MotionEvent.ACTION_MOVE:
                // 计算偏移量
                int offsetX = x - lastX;
                int offsetY = y - lastY;
                if (mOnScroolInstanceListener != null) {
                    mOnScroolInstanceListener.scroolDistance(offsetY);
                }
                Log.e("GestureImageView", "offsetY:" + offsetY);
                break;
            case MotionEvent.ACTION_UP:
                if (mOnScroolInstanceListener != null) {
                    mOnScroolInstanceListener.scroolDistance(0);
                }
                Log.e("GestureImageView", "ACTION_UP offsetY:");
                break;
        }
    ...
    public void setOnScroolInstanceListener(OnScroolInstanceListener onScroolInstanceListener) {
        this.mOnScroolInstanceListener = onScroolInstanceListener;
    }

    public interface OnScroolInstanceListener {

        void scroolDistance(int distance);
